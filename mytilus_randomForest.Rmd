...
spplot(Predictor,"predictionWithDepth",main=list("Occurence probability",cex=1),
       ...
       sp.layout=list(
         ...
         list("panel.points",cities_subset$long,cities_subset$lat,pch=1),
...
grid.text("WGS84",x=unit(0.8,"npc"),y=unit(0.1,"npc"))
...
spplot(depth.pixel,"V3",
       ...
       col.regions=c(water_color,land_color),
       at=c(seq(from=-1547.00,to=0,by=1550/11),seq(0,1626.00,by=1626/20)),
       scales=list(draw=TRUE)
       )
