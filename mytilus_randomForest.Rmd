...
library(grDevices)
water_color <-  topo.colors(32)[1:11]
land_color <- topo.colors(32)[13:32]
...
depth.pixel_on_sed.pixel <- readRDS("etopo1_interpolated_to_noah_grainsize_grid.rda")
depth.pixel_on_sed.pixel$V3 <- depth.pixel_on_sed.pixel$V3*(-1)
depth.pixel_on_sed.pixel <- subset(depth.pixel_on_sed.pixel,depth.pixel_on_sed.pixel$V3>0)
spplot(depth.pixel_on_sed.pixel,"var1.pred",formula=-var1.pred~lon+lat,
...
#saveRDS(object=depth.pixel_on_sed.pixel,file="depth_mgs_pixel")
...
depth_on_absencepoints <- depth_on_absencepoints[!is.na(depth_on_absencepoints$V3),]
...
depth_on_presencepoints <- depth_on_presencepoints[!is.na(depth_on_presencepoints$V3),]
